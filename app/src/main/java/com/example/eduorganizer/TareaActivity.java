...
public class TareaActivity extends AppCompatActivity {
    ...
    private void mostrarTareas(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            final CheckBox checkBox = new CheckBox(TareaActivity.this);
            ...
            checkBox.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(TareaActivity.this, "Tarea Realizada", Toast.LENGTH_SHORT).show();
                    // Animar la eliminación del CheckBox
                    Animation animation = AnimationUtils.loadAnimation(TareaActivity.this, R.anim.slide_out_right);
